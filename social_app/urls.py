...
urlpatterns = [
    ...
    path('users/<int:user_id>/follow/reject/', FollowRequestViewSet.as_view({'post': 'reject_request'}), name='reject_follow_request'),
    ...
    path('users/<int:user_id>/report/', ReportViewSet.as_view({'post': 'report_user'}), name='report_user'),
    path('users/block-reasons/', BlockReasonListView.as_view(), name='block_reasons'),
    path('users/report-reasons/', ReportReasonListView.as_view(), name='report_reasons'),
]
